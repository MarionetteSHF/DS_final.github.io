...
We performed cross validation using these 3 models and model3 gives us a relatively low rmse . So we concluded that, to predict how many school bus delay may occur Mahanttan in one day, we would use month,rainfall,snow depth, and weekday as predictors .
